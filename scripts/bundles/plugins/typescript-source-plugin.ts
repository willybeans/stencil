...
/**
 * Creates a rollup plugin to embed a version of the TypeScript compiler into the Stencil compiler
 ...
 * modifications to the TypeScript source in order for Stencil to work in both Node and Deno-based environments.
